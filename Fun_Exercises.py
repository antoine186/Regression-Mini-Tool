...
### We will train our own univariate regression model using gradient descent, batch and stochastic
...
### We will train our own multivariate regression model using gradient descent, batch and stochastic
